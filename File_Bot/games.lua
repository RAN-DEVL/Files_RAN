...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙اسرع واحد يدز هاذا السمايل ?* » {`'..SM..'`}')
return false
end
end
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙الف مبروك لقد فزت* \n *◜#ُِ︙للعب مره اخره ارسل »{ سمايل , سمايلات }*')
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙اسرع واحد يرتبها* » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙الف مبروك لقد فزت* \n *◜#ُِ︙للعب مره اخره ارسل »{ الاسرع , ترتيب }*')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙اسرع واحد يحل الحزوره* ↓\n {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙اسرع واحد يدز معنى السمايل* » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙اسرع واحد يدز العكس* » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_," ◜#ُِ︙عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙مبروك فزت ويانه وخمنت الرقم الصحيح*\n *◜#ُِ︙تم اضافة { 5 } من النقاط* \n')
...
database:del(bot_id..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' *◜#ُِ︙اوبس لقد خسرت في اللعبه* \n *◜#ُِ︙حظآ اوفر في المره القادمه* \n *◜#ُِ︙كان الرقم الذي تم تخمينه { '..GETNUM..' }*')
else
send(msg.chat_id_, msg.id_,' *◜#ُِ︙اوبس تخمينك غلط* \n *◜#ُِ︙ارسل رقم تخمنه مره اخرى* ')
end
end
end
end
...
send(msg.chat_id_, msg.id_,'\n ◜#ُِ︙اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n'..' ◜#ُِ︙ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n'..' ◜#ُِ︙سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ')
...
send(msg.chat_id_, msg.id_," ◜#ُِ︙عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false  end 
local GETNUM = database:get(bot_id.."Games:Bat"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' *◜#ُِ︙مبروك فزت وطلعت المحيبس بل ايد رقم* { '..NUM..' }\n *◜#ُِ︙لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل* ')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' *◜#ُِ︙للاسف لقد خسرت* \n *◜#ُِ︙المحيبس بل ايد رقم* { '..GETNUM..' }\n *◜#ُِ︙حاول مره اخرى للعثور على المحيبس*')
end
end
end
...
↓      ↓     ↓      ↓     ↓     ↓   
👊 ‹•› 👊 ‹•› 👊 ‹•› 👊 ‹•› 👊 ‹•› 👊
◜#ُِ︙اختر لأستخراج المحيبس الايد التي تحمل المحيبس 
 ◜#ُِ︙الفائز يحصل على { 3 } من النقاط *
]]
...
name = string.gsub(name,'⌛️','⏳⏳⏳⏳⏳⏳⌛️⏳⏳')
name = string.gsub(name,'📅','📆📆📆📆📆📆📅📆📆')
send(msg.chat_id_, msg.id_,' *◜#ُِ︙اسرع واحد يدز الاختلاف* » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙حل المسأله الرياضيه*  » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙ترجم الكلمات الاتيه*  » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' *◜#ُِ︙اسرع واحد يكمل المثل* » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
