...
if not database:get(bot_id..'RAN:Reply:Mute'..msg.chat_id_) then
if text == 'هلو' then
TextReply = 'ههلو ، 🥳😹💞'
...
database:del(bot_id..'RAN:Reply:Mute'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'⌔︙تم تفعيل ردود البوت')
return false
end

if text == 'تعطيل ردود البوت' and Owner(msg) then
database:set(bot_id..'RAN:Reply:Mute'..msg.chat_id_,true)
