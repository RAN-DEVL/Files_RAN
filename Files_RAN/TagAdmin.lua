...
k = k + 1
local username = database:get(bot_id.."RAN:User:Name"..v.user_id_)
if username then
t = t..""..k.."- ([@"..username.."])\n"
else
t = t..""..k.."- (`"..v.user_id_.."`)\n"
