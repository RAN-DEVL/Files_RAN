...
send(msg.chat_id_, msg.id_,' *𖡺︙اسرع واحد يدز هاذا السمايل ?* » {`'..SM..'`}')
return false
end
end
...
send(msg.chat_id_, msg.id_,' *𖡺︙الف مبروك لقد فزت* \n *𖡺︙للعب مره اخره ارسل »{ سمايل , سمايلات }*')
...
send(msg.chat_id_, msg.id_,' *𖡺︙اسرع واحد يرتبها* » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' *𖡺︙الف مبروك لقد فزت* \n *𖡺︙للعب مره اخره ارسل »{ الاسرع , ترتيب }*')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_,' *𖡺︙اسرع واحد يحل الحزوره* ↓\n {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' *𖡺︙اسرع واحد يدز معنى السمايل* » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' *𖡺︙اسرع واحد يدز العكس* » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_," 𖡺︙عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
...
send(msg.chat_id_, msg.id_,' *𖡺︙مبروك فزت ويانه وخمنت الرقم الصحيح*\n *𖡺︙تم اضافة { 5 } من النقاط* \n')
...
database:del(bot_id..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' *𖡺︙اوبس لقد خسرت في اللعبه* \n *𖡺︙حظآ اوفر في المره القادمه* \n *𖡺︙كان الرقم الذي تم تخمينه { '..GETNUM..' }*')
else
send(msg.chat_id_, msg.id_,' *𖡺︙اوبس تخمينك غلط* \n *𖡺︙ارسل رقم تخمنه مره اخرى* ')
end
end
end
end
...
send(msg.chat_id_, msg.id_,'\n 𖡺︙اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n'..' 𖡺︙ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n'..' 𖡺︙سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ')
...
send(msg.chat_id_, msg.id_," 𖡺︙عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false  end 
local GETNUM = database:get(bot_id.."Games:Bat"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' *𖡺︙مبروك فزت وطلعت المحيبس بل ايد رقم* { '..NUM..' }\n *𖡺︙لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل* ')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' *𖡺︙للاسف لقد خسرت* \n *𖡺︙المحيبس بل ايد رقم* { '..GETNUM..' }\n *𖡺︙حاول مره اخرى للعثور على المحيبس*')
end
end
end
...
↓      ↓     ↓      ↓     ↓     ↓   
👊 ‹•› 👊 ‹•› 👊 ‹•› 👊 ‹•› 👊 ‹•› 👊
𖡺︙اختر لأستخراج المحيبس الايد التي تحمل المحيبس 
 𖡺︙الفائز يحصل على { 3 } من النقاط *
]]
...
name = string.gsub(name,'⌛️','⏳⏳⏳⏳⏳⏳⌛️⏳⏳')
name = string.gsub(name,'📅','📆📆📆📆📆📆📅📆📆')
send(msg.chat_id_, msg.id_,' *𖡺︙اسرع واحد يدز الاختلاف* » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' *𖡺︙حل المسأله الرياضيه*  » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' *𖡺︙ترجم الكلمات الاتيه*  » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' *𖡺︙اسرع واحد يكمل المثل* » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
