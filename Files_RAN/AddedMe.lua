...
database:del(bot_id..'RAN:Lock:Added:Me'..msg.chat_id_)  
send(msg.chat_id_, msg.id_,'⌔︙تم تفعيل امر منو ضافني') 
return false
end
if text == 'تعطيل ضافني' and Owner(msg) then  
database:set(bot_id..'RAN:Lock:Added:Me'..msg.chat_id_,true)  
send(msg.chat_id_, msg.id_,'⌔︙تم تعطيل امر منو ضافني') 
return false
end
if text and text:match("(.*)(ضافني)(.*)") then
if not database:get(bot_id..'RAN:Lock:Added:Me'..msg.chat_id_) then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da and da.status_.ID == "ChatMemberStatusCreator" then
send(msg.chat_id_, msg.id_,'⌔︙انت منشئ المجموعه ') 
return false
end
local Added_Me = database:get(bot_id.."RAN:Who:Added:Me"..msg.chat_id_..':'..msg.sender_user_id_)
if Added_Me then 
